    ...
    public class Drawable : MonoBehaviourPun
    {
        ...
        public void BrushTemplate(Vector2 world_position)
        {
            ...
            if (previous_drag_position == Vector2.zero)
            {
                ...
                photonView.RPC("MarkPixelsToColour", RpcTarget.Others, pixel_pos, Pen_Width/*, Pen_Colour*/);
                MarkPixelsToColour(pixel_pos, Pen_Width);
            ...
            else
            {
                ...
                photonView.RPC("ColourBetween", RpcTarget.Others, previous_drag_position, pixel_pos, Pen_Width/*, Pen_Colour*/);
                ColourBetween(previous_drag_position, pixel_pos, Pen_Width);
            ...
            //photonView.RPC("ApplyMarkedPixelChanges", RpcTarget.AllBuffered);
        ...
        void FixedUpdate()
        {
            ...
            if (mouse_held_down && !no_drawing_on_current_drag)
            {
                ...
                if (hit != null && hit.transform != null && !iswaitforsec /*&& isDrawAllowed*/)
                {
                    ...
                    // Use whatever function the current brush is
                    //photonView.RPC("current_brush", RpcTarget.All, mouse_world_position);
                    //StartCoroutine(brushing(mouse_world_position));
        ...
        IEnumerator brushing(Vector2 mouse_world_position)
        {
            iswaitforsec = true;
        ...
        public void ColourBetween(Vector2 start_point, Vector2 end_point, int width/*, Color color*/)
        {
            ...
            for (float lerp = 0; lerp <= 1; lerp += lerp_steps)
            {
                ...
                //photonView.RPC("MarkPixelsToColour", RpcTarget.AllBuffered, cur_position, width);
        ...
        public void MarkPixelsToColour(Vector2 center_pixel, int pen_thickness/* Color color_of_pen*/)
        {
            ...
            for (int x = center_x - pen_thickness; x <= center_x + pen_thickness; x++)
            {
                ...
                {
                    //photonView.RPC("MarkPixelToChange", RpcTarget.AllBuffered, x, y);
        ...
        public void MarkPixelToChange(int x, int y/*, Color color*/)
        {
            ...
            if (array_pos > cur_colors.Length || array_pos < 0)
                return;
            cur_colors[array_pos] = brushcolor;
        ...
        void Awake()
        {
            StartCoroutine(brushing(new Vector2(0f,0f)));
